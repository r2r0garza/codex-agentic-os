...
1. Continue deterministic repository indexing with manifests, serialized artifacts, atomic writes, and clean rebuilds; see `.plan/0002-deterministic-repository-index.md`.
